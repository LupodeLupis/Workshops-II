...
namespace sict {
	...
	// Implement the * operartor
	Fraction Fraction::operator*(const Fraction& rhs) const {

		if (this->isEmpty() == false && rhs.isEmpty() == false) {

			Fraction temp1;
			temp1.numerator = (this->numerator * rhs.numerator);
			temp1.denominator = (this->denominator * rhs.denominator);
			temp1.reduce();
			return temp1;
		}
		else
	...
	bool Fraction::operator==(const Fraction& rhs) const {
		...
		return (this->isEmpty() == false && rhs.isEmpty() == false && this->numerator == rhs.numerator
			&& this->denominator == rhs.denominator) ? true : false;
	}
